...
function Login() {
    ...
    var submissionHandler = function (event) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Axios.post("http://localhost:3000/login", {
                            email: email,
                            password: password,
                        }, {
                            headers: {
    ...
    return (_jsx("div", { children: _jsxs(Card, { className: classes.login, "data-testid": "login-card", children: [errorMessage && _jsx("p", { className: classes.error, children: errorMessage }), _jsxs("form", { className: classes.form, onSubmit: submissionHandler, children: [_jsx("label", { children: "Email address" }), _jsx("input", { type: "email", name: "email", value: email, onChange: function (event) { return setEmail(event.target.value); }, placeholder: "name@example.com" }), _jsx("label", { children: "Password" }), _jsx("input", { type: "password", name: "password", value: password, onChange: function (event) { return setPassword(event.target.value); } }), _jsx("div", { className: classes.actions, children: _jsx("button", { type: "submit", children: "Submit" }) })] })] }) }));
}
