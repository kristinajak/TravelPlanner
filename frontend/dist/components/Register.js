...
function Register() {
    ...
    return (_jsxs(Card, { className: classes.register, children: [errorMessage && _jsx("p", { children: errorMessage }), _jsxs("form", { onSubmit: submissionHandler, children: [_jsx("label", { children: "Email address" }), _jsx("input", { type: "email", name: "email", value: email, onChange: function (event) { return setEmail(event.target.value); }, placeholder: "name@example.com" }), _jsx("label", { children: "Password" }), _jsx("input", { type: "password", name: "password", value: password, onChange: function (event) { return setPassword(event.target.value); } }), _jsx("label", { children: "Password Confirmation" }), _jsx("input", { type: "password", name: "passwordConfirmation", value: passwordConfirmation, onChange: function (event) { return setPasswordConfirmation(event.target.value); } }), _jsx("button", { type: "submit", disabled: errorMessage !== undefined, children: "Submit" })] })] }));
}
